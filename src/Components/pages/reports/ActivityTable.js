  ...
  return (
    <div className='activity-table'>
      ...
      <div className='table-body'>
        ...
        <div className='table-row'>
          <div className='table-cell w-20 candidates-col'> <span>2</span> Nicola Palumbo</div>
          <div className='table-cell w-20'>Information Security Basics</div>
          <div className='table-cell w-15'>24/09/21</div>
          <div className='table-cell w-15'>00:22:35</div>
          <div className='table-cell w-15 status-cell'>Invited</div>
          <div className='table-cell w-20 results-col'>7/10 <span> <SvgStarSvg /> (3) </span> <SvgLikeSvg className='like-svg'/> (5) </div>
          <div className='table-cell w-5 reviews-col'><SvgReviewSvg /></div>
        </div> 
        <div className='table-row'>
          <div className='table-cell w-20 candidates-col'> <span>3</span> Nicola Palumbo</div>
          <div className='table-cell w-20'>Information Security Basics</div>
          <div className='table-cell w-15'>24/09/21</div>
          <div className='table-cell w-15'>00:22:35</div>
          <div className='table-cell w-15 status-cell'>Invited</div>
        ...
        <div className='table-row'>
          <div className='table-cell w-20 candidates-col'> <span>4</span> Nicola Palumbo</div>
          <div className='table-cell w-20'>Information Security Basics</div>
          <div className='table-cell w-15'>24/09/21</div>
          <div className='table-cell w-15'>00:22:35</div>
          <div className='table-cell w-15 status-cell'>Invited</div>
        ...
        <div className='table-row'>
          <div className='table-cell w-20 candidates-col'> <span>5</span> Nicola Palumbo</div>
          <div className='table-cell w-20'>Information Security Basics</div>
          <div className='table-cell w-15'>24/09/21</div>
          <div className='table-cell w-15'>00:22:35</div>
          <div className='table-cell w-15 status-cell'>Invited</div>
        ...
        <div className='table-row'>
          <div className='table-cell w-20 candidates-col'> <span>6</span> Nicola Palumbo</div>
          <div className='table-cell w-20'>Information Security Basics</div>
          <div className='table-cell w-15'>24/09/21</div>
          <div className='table-cell w-15'>00:22:35</div>
          <div className='table-cell w-15 status-cell'>Invited</div>
        ...
        <div className='table-row'>
          <div className='table-cell w-20 candidates-col'> <span>7</span> Nicola Palumbo</div>
          <div className='table-cell w-20'>Information Security Basics</div>
          <div className='table-cell w-15'>24/09/21</div>
          <div className='table-cell w-15'>00:22:35</div>
          <div className='table-cell w-15 status-cell'>Invited</div>
        ...
        <div className='table-row'>
          <div className='table-cell w-20 candidates-col'> <span>8</span> Nicola Palumbo</div>
          <div className='table-cell w-20'>Information Security Basics</div>
          <div className='table-cell w-15'>24/09/21</div>
          <div className='table-cell w-15'>00:22:35</div>
          <div className='table-cell w-15 status-cell'>Invited</div>
        ...
        <div className='table-row'>
          <div className='table-cell w-20 candidates-col'> <span>9</span> Nicola Palumbo</div>
          <div className='table-cell w-20'>Information Security Basics</div>
          <div className='table-cell w-15'>24/09/21</div>
          <div className='table-cell w-15'>00:22:35</div>
          <div className='table-cell w-15 status-cell'>Invited</div>
        ...
        <div className='table-row'>
          <div className='table-cell w-20 candidates-col'> <span>10</span> Nicola Palumbo</div>
          <div className='table-cell w-20'>Information Security Basics</div>
          <div className='table-cell w-15'>24/09/21</div>
          <div className='table-cell w-15'>00:22:35</div>
          <div className='table-cell w-15 status-cell'>Invited</div>
